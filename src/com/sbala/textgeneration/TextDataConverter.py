...
class DownloadDataSet(object):
    ...
    def downloadFile(self):
        file_path = tf.keras.utils.get_file('/home/balasubramanyas/ProjectWorkspace/Dataset/shakespeare.txt', 'https://storage.googleapis.com/download.tensorflow.org/data/shakespeare.txt');
        return file_path;
